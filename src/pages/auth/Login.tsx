  ...
  return (
    ...
    >
      <div className="w-full max-w-md px-4">
        ...
        >
          <div style={{ marginBottom: '8px', fontSize: '15px', fontWeight: 500, color: '#ffffff', textAlign: 'center' }}>
            Benvenuto
          </div>
          <div style={{ fontSize: '13px', color: '#888888', textAlign: 'center', marginBottom: '28px' }}>
